...
class EmailService {
  ...
  // Envoyer un email de confirmation d'emprunt
  async sendBorrowingConfirmation(userEmail, userName, bookTitle, bookAuthor = '', dueDate) {
    ...
    const mailOptions = {
      from: process.env.EMAIL_USER || 'bibliotheque@universite.com',
      to: userEmail,
      subject: '✅ Confirmation d\'emprunt - Bibliothèque Universitaire',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #28a745;">✅ Emprunt confirmé</h2>
          ...
          <div style="background-color: #d4edda; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #28a745;">
            <h3 style="color: #155724; margin: 0 0 10px 0;">📖 ${bookTitle}</h3>
            ${bookAuthor ? `<p style="color: #155724; margin: 5px 0;"><strong>Auteur :</strong> ${bookAuthor}</p>` : ''}
            <p style="color: #155724; margin: 5px 0;">
              <strong>📅 Date de retour :</strong> ${formattedDueDate}
            </p>
          </div>
          
          <div style="background-color: #fff3cd; padding: 15px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #ffc107;">
            <h4 style="color: #856404; margin: 0 0 10px 0;">📋 Rappels importants :</h4>
            <ul style="color: #856404; margin: 0; padding-left: 20px;">
              <li>Veillez à retourner le livre avant la date limite</li>
              <li>Vous recevrez un rappel la veille de l'échéance</li>
              <li>Des retards peuvent entraîner des restrictions d'emprunt</li>
            </ul>
          </div>
    ...
    try {
      ...
      console.error(`❌ Erreur envoi confirmation à ${userEmail}:`, error.message);
      return false;
    }
  }
